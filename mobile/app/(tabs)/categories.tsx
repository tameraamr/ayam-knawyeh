...
const styles = StyleSheet.create({
  ...
  catName: { fontSize: 12, color: '#d1d5db', fontWeight: '600', textAlign: 'center' },
  results: { flex: 1, paddingHorizontal: 16 },
  resultsTitle: { fontSize: 16, fontWeight: '700', color: '#f9fafb', textAlign: 'right', marginBottom: 12 },
  ...
  resultTitle: { color: '#e5e7eb', fontSize: 14, fontWeight: '600', textAlign: 'right', lineHeight: 20 },
  resultDate: { color: '#6b7280', fontSize: 12, textAlign: 'right', marginTop: 4 },
