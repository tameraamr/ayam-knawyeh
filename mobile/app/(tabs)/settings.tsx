...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: '600', color: '#6b7280', textAlign: 'right', marginBottom: 8, paddingHorizontal: 4 },
  ...
  about: { color: '#9ca3af', fontSize: 14, lineHeight: 22, textAlign: 'right', padding: 14 },
