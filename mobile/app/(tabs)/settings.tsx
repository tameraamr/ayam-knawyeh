...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 22, fontWeight: '800', color: '#f9fafb', writingDirection: 'rtl' },
  appVersion: { fontSize: 13, color: '#6b7280', writingDirection: 'rtl' },
  ...
  rowLabel: { color: '#d1d5db', fontSize: 14, writingDirection: 'rtl' },
  rowValue: { color: '#6b7280', fontSize: 13, maxWidth: '55%', textAlign: 'left' },
